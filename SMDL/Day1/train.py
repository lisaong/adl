...
sequence_len = df_train['prompt'].apply(lambda x: len(word_tokenize(x))).median()
...
vectorizer = TextVectorization(max_tokens=20000, output_sequence_length=int(sequence_len))
